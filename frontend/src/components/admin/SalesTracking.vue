...
<template>
    <div class="h-full flex flex-col bg-white">
        ...
        <Dialog v-model:open="showSaleDialog">
         <DialogContent class="sm:max-w-md rounded-2xl border-zinc-200/60 p-0 overflow-hidden shadow-2xl bg-white/95 backdrop-blur-xl animate-in zoom-in-95 duration-200 text-black">
                ...
                <form @submit.prevent="saveSale" class="p-6 space-y-5">
                    ...
                    <div class="space-y-3 pb-3 border-b border-zinc-100">
                        <div class="flex items-center justify-between">
                            ...
                            <button 
                                ...
                                class="text-xs font-bold text-black bg-zinc-100 hover:bg-zinc-200 px-3 py-1.5 rounded-xl transition-colors uppercase tracking-wide"
                            >
                        ...
                        <div v-else>
                            <Input v-model="saleForm.title" required placeholder="Ex: Prestation Site Web" class="rounded-xl border-zinc-300 focus:border-zinc-950 focus:ring-1 focus:ring-zinc-950 bg-white text-black font-medium" />
                        </div>
                    </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <textarea 
                            ...
                            class="w-full px-3 py-2 border border-zinc-300 rounded-xl focus:border-zinc-950 outline-none text-sm min-h-[60px] resize-none bg-white text-black font-medium"
                        ></textarea>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                         <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                <Input v-model="saleForm.amount" type="number" step="0.01" required placeholder="0.00" class="pl-8 rounded-xl border-zinc-300 focus:border-zinc-950 focus:ring-1 focus:ring-zinc-950 bg-white text-black font-medium font-mono" />
                        ...
                        <div class="space-y-1.5">
                            ...
                            <Input v-model="saleForm.date" type="date" required class="rounded-xl border-zinc-300 focus:border-zinc-950 focus:ring-1 focus:ring-zinc-950 bg-white text-black font-medium" />
                        </div>
                    </div>

                    <div class="space-y-1.5">
                        <label class="text-[10px] font-bold uppercase tracking-widest text-zinc-500">Statut</label>
                        <select v-model="saleForm.status" class="w-full h-10 px-3 rounded-xl border border-zinc-300 focus:border-zinc-950 outline-none appearance-none bg-white text-sm font-medium">
                    ...
                    <div class="flex justify-end gap-3 pt-4 border-t border-zinc-100 mt-2">
                        <Button type="button" variant="ghost" @click="showSaleDialog = false" class="rounded-xl hover:bg-zinc-100 text-zinc-500">
                            Annuler
                        </Button>
                        <Button type="submit" class="bg-zinc-950 hover:bg-zinc-900 text-white rounded-xl min-w-[120px] font-bold shadow-sm transition-all hover:scale-[1.02] active:scale-[0.98]">
